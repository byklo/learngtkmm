  ...
  m_Button_Quit(Gtk::Stock::QUIT)
{
  ...
  m_Button_Quit.signal_clicked().connect(sigc::mem_fun(*this,
              &LoadingWindow::on_button_quit) );
  m_Button_Start.signal_clicked().connect(sigc::mem_fun(*this,
              &LoadingWindow::on_button_start) );
...
void LoadingWindow::on_button_quit()
{
  hide();
}

void LoadingWindow::on_button_start()
{
  ...
  {
     std::cout << "Loading gtkmm example: " << i << " of "
         << max << std::endl;
